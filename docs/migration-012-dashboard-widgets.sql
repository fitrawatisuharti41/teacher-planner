-- ============================================================
-- Migration 012: Widget Ringkasan Dashboard Wali Kelas
-- Jalankan di Supabase SQL Editor SETELAH migration-011
-- ============================================================

-- 1. Kolom baru yang dibutuhkan widget dashboard
...
-- 2. Mood Kelas Hari Ini — 1 baris per kelas per tanggal
create table if not exists class_mood (
  ...
  mood text not null, -- 'senang' | 'biasa' | 'lelah' | 'sedih' | 'marah'
...
-- 3. class_development_summary — tambah semua widget dashboard baru
